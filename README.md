...
| `VRS_ENHANCED_LAYERS_THUNDERFOREST_APIKEY` | For the Spinal Map to work, you need an API key. Again,  [here](https://github.com/rikgale/VRSCustomLayers) are more details, and instructions how to obtain an API key. | `unset` |
